...
Xcodebuild -workspace AntMediaReferenceApplication.xcworkspace -scheme WebRTCiOSSDK -sdk iphonesimulator ARCHS=x64 -configuration Release install CONFIGURATION_BUILD_DIR=${SIMULATOR_DIR}
